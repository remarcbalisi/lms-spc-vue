                ...
                <form class="w-full max-w-md">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <input v-model="name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey" name="name" id="role-name" type="text" placeholder="Role Name">
                        </div>
                    </div>
    ...
    export default {
        ...
        methods: {
            create() {
                ...
                api.call('post', '/api/admin/roles/store', data).then((response)=>{
                    this.creating = false;
